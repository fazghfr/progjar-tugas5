...
class BackendList:
    def __init__(self):
        self.servers = []
        self.servers.append(('172.16.16.101', 1111))
        self.servers.append(('172.16.16.101', 1112))
        self.servers.append(('172.16.16.101', 1113))
        self.servers.append(('172.16.16.101', 1114))
        self.current = 0
